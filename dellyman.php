...
if (in_array('woocommerce/woocommerce.php', apply_filters('active_plugins', get_option('active_plugins')))) {
                ...
                function init_form_fields()
                {
                    ...
                    $this->form_fields = array(
                        ...
                        'dlogin' => array(
                            'title' => 'Login',
                            'type' => 'text',
                            'description' => 'Dellyman Login/username',
                            'default' => '',
                        ),
                        'dpassword' => array(
                            'title' => 'Password',
                        ...
                        'PickUpContactName' => array(
                            ...
                            'type' => 'text',
                            'description' => 'PickUp contact person phone name',
                            'default' => '',
                        ),
                        'PickUpContactNumber' => array(
                            'title' => 'PickUp Contact Number',
                            'type' => 'text',
                            'description' => 'PickUp contact person phone number',
                            'default' => '',
                        ),
                        'PickUpGooglePlaceAddress' => array(
                            'title' => 'PickUp Address',
                            'type' => 'text',
                            'description' => 'This is the place where the rider(s) will always come to pick an order for delivery',
                            'default' => '',
                        ),
    ...
    function dellyman_logistics_shipping_method($methods)
    {
